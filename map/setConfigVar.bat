...
set "_uriCurrent=/download/"

rem set "_siteUriCurrent=%_uriCurrent%/x86_64/release/curl/"
rem set "_siteUriCurrent=%_uriCurrent%/src/release/"
set "_siteUriCurrent=%_uriCurrent%"

rem set "_sourceMarkerCurrent=src.tar.xz"
set "_sourceMarkerCurrent=-[0-9].*src.tar.xz"
rem set "_sourceMarkerCurrent=/"

rem set "_findRegExCurrent=%_siteUriCurrent%%_programCurrent%%_sourceMarkerCurrent%"
set "_findRegExCurrent=\/download\/curl-[0-9].*tar.xz"

set "_prependUriCurrent=1"
set "_prependPathCurrent=https://curl.se"
...
set _extractInstallUriCurrent=curl -s %_siteCurrent%  ^| findstr /R "%_findRegExCurrent%" ^| head -n 1
